execute as @e[type=#fastpath:fastable] at @s if block ~ ~ ~ dirt_path run attribute @s minecraft:generic.movement_speed modifier add 423-223-323-123-23 path.speed 0.75 multiply_base
